...
// include vehicle emission by applying Odd Even concept for all types of vehicles. The vehicles with the odd last digit in the 
...
public class Fine {
    public static void solve(int[] arr, int d, int x) {
        if (d % 2 == 0) {
            int count = 0;
